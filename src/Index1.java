...
public class Index1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		PrintWriter pw=response.getWriter();
				...
				pw.println("<head>");
				pw.println("<title> ProMp3 Website Template | Home1</title>);");
				pw.println("<link href=css/style.css rel=stylesheet type=text/css media=all />");
				    ...
				    pw.println("</head>");
				    	    ...
				    	    pw.println("</div>");
				    	    	...
				    	    	pw.println("<div class='grid_1_of_4 images_1_of_4'>");
				    	    	pw.println("<div class='grid-img'>");
				    	    	pw.println("<img src=images/pic.jpg alt= />");
				    	    	pw.println("<h3>Rock </h3>");
				    	    	pw.println("<div class='views'></div>");
				    	    	pw.println("</div>");
				    	    	pw.println("</div>");
				    	    	pw.println("<div class='grid_1_of_4 images_1_of_4'>");
				    	    	pw.println("<div class='grid-img'>");
				    	    	pw.println("<img src=images/pic1.jpg alt=/>");
				    	    	pw.println("<h3>Hip Hop </h3>");
				    	    	pw.println("<div class=views></div>");
				    	    	pw.println("</div>");
				    	    	pw.println("</div>");
				    	    	pw.println("<div class='grid_1_of_4 images_1_of_4'>");
				    	    	pw.println("<div class='grid-img'>");
				    	    	pw.println(" <img src=images/pic2.jpg alt=/>");
				    	    	pw.println("<h3>Pop </h3>");
				    	    	pw.println("<div class=views></div>");
				    	    	pw.println("</div>");
				    	    	pw.println("</div>");
				    	    	pw.println("<div class='grid_1_of_4 images_1_of_4'>");
				    	    	pw.println("<div class='grid-img'>");
				    	    	pw.println("<img src=images/pic3.jpg alt=/>");
				    	    	pw.println("<h3>Jazz </h3>");
				    	    	pw.println("<div class=views></div>");
				    	    	pw.println("</div>");
				    	    	pw.println("</div>");
				    	    	pw.println("<div class=clear></div>"); 
				    	    	pw.println("</div>");
				    	    	pw.println("<div class=content-middle>");
				    	    	pw.println("<div class=content-panel>");
				    	    	pw.println("<div class=span1><p>&nbsp;</p>");
				    	    	pw.println("<h2 style=text-align: right;>&nbsp;Welcome!</h2>");
				    	    	pw.println("</div>");
				    	    	pw.println("<div class=span2>");
				    	    	pw.println("<div class=vertical-divider>Pro mp3 is Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudan tium totam rem aperiam eaque ipsa quae ab illo inventore veritatis et quasi archit ecto beatae vitae dicta sunt explicabo. Nemo enim ipsam.</div>"); 
				    	    	pw.println("</div>");
				    	    	pw.println("<div class=clear></div>");
				    	    	pw.println("</div>");
				    	    	pw.println("</div>");
